...
Cal.prototype.showMonth = function (y, m) {
    ...
    for (var i = 0; i < this.DaysOfWeek.length; i++) {
        html += '<td>' + this.DaysOfWeek[i] + '</td>';//для проверки ввиде а '<a href="/day.html">'.....'</a>'
    }
    html += '</tr>';
    ...
    do {
        ...
        if (chkY == this.currYear && chkM == this.currMonth && i == this.currDay) {
            html += '<td class="today">' + '<a href="home/day?day=' + i + '&month=' + (this.currMonth+1) +
                '&year=' + this.currYear +'" >' + i + '</a>' + '</td>';
        } else {
            html += '<td class="normal">' + '<a href="home/day?day=' + i + '&month=' + (this.currMonth+1) +
                '&year=' + this.currYear +'" >' + i + '</a>' + '</td>';
        }
